...
public class ImGuiRenderer : IDisposable {
    ...
    public ImGuiRenderer(int width, int height) {
        ...
        io.DisplaySize = new System.Numerics.Vector2(
            Application.Instance.OpenTKWindow.Size.X,
            Application.Instance.OpenTKWindow.Size.Y
        ); 
        var scaleX = (float)Application.Instance.OpenTKWindow.FramebufferSize.X / Application.Instance.OpenTKWindow.Size.X;
        var scaleY = (float)Application.Instance.OpenTKWindow.FramebufferSize.Y / Application.Instance.OpenTKWindow.Size.Y;
...
void main()
{
    ...
    public void RecreateFontDeviceTexture() {
        ...
        //  LabelObject(LabelO.Texture, _fontTexture, "ImGui Text Atlas");
    ...
    public void Render() {
        if (_frameBegun) {
            ...
            var wnd = Application.Instance.OpenTKWindow;

            GL.Viewport(
                0,
                0,
                wnd.FramebufferSize.X,
    ...
    public void Update(GameWindow wnd, float deltaSeconds) {
        ...
        var scaleX = (float)wnd.FramebufferSize.X / wnd.Size.X;
        var scaleY = (float)wnd.FramebufferSize.Y / wnd.Size.Y;
        io.DisplayFramebufferScale = new System.Numerics.Vector2(scaleX, scaleY);
    ...
    private void UpdateImGuiInput(GameWindow wnd) {
        ...
        io.MousePos = new System.Numerics.Vector2(
            MouseState.Position.X / scale.X,
            MouseState.Position.Y / scale.Y
        );
    ...
    private void RenderImDrawData(ImDrawDataPtr draw_data) {
        ...
        unsafe {
            fixed (int* iptr = &prevScissorBox[0]) {
                GL.GetInteger(GetPName.ScissorBox, (uint)iptr);
            }
        }
        ...
        unsafe {
            fixed (int* iptr = &prevPolygonMode[0]) {
                GL.GetInteger(GetPName.PolygonMode, (uint)iptr);
            }
        }
        ...
        for (int n = 0; n < draw_data.CmdListsCount; n++) {
            ...
            for (int cmd_i = 0; cmd_i < cmd_list.CmdBuffer.Size; cmd_i++) {
                ...
                if (pcmd.UserCallback != IntPtr.Zero) {
                    ...
                    int fbHeight = Application.Instance.OpenTKWindow.FramebufferSize.Y;
                    ...
                    if ((io.BackendFlags & ImGuiBackendFlags.RendererHasVtxOffset) != 0) {
                        GL.DrawElementsBaseVertex(PrimitiveType.Triangles, (int)pcmd.ElemCount, DrawElementsType.UnsignedShort, (IntPtr)(pcmd.IdxOffset * sizeof(ushort)),
