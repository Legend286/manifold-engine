...
public static class ForwardRenderer {
    ...
    // Keep the batching dictionary so API stays same
    private static Dictionary<InstanceBatchKey, List<Matrix4>> _instanceBatches =
        new Dictionary<InstanceBatchKey, List<Matrix4>>(128);
